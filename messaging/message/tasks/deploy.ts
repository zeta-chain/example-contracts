...
const deployContract = async (
  ...
  console.log(`zetaTokenConsumerUniV2: ${zetaTokenConsumerUniV2}`);
  console.log(`zetaTokenConsumerUniV3: ${zetaTokenConsumerUniV3}`);
  console.log(zetaTokenConsumerUniV3 || zetaTokenConsumerUniV2);
