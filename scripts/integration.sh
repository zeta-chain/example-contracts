...
npx hardhat destination --contract $OMNI_MULTIOUTPUT_CONTRACT --network goerli_testnet --destination mumbai_testnet
npx hardhat destination --contract $OMNI_MULTIOUTPUT_CONTRACT --network goerli_testnet --destination bsc_testnet
